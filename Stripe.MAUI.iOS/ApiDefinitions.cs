...
namespace Stripe
{
	...
	// @interface StripePaymentSheet_Swift_276 (STPAddressViewController) <UIGestureRecognizerDelegate>
	[Category]
	[BaseType (typeof(STPAddressViewController))]
	interface STPAddressViewController_StripePaymentSheet_Swift_276 : IUIGestureRecognizerDelegate
	{
